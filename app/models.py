...
#     # Relationship to know who created this user
#     created_by = relationship("User", remote_side=[id], foreign_keys=[created_by_id], backref="created_users")
    ...
    tasks_assigned = relationship("Task", foreign_keys="Task.assigned_by_id", backref="assigned_by")
    tasks_received = relationship("Task", foreign_keys="Task.assigned_to_id", backref="assigned_to")
...
class Task(Base):
    ...
    history = relationship("TaskHistory", backref="task", cascade="all, delete")
